...
public void check_for_the_items_added_to_the_cart() {
	...
	String s=crt.verifyProduct();
	
	if(s.contains("Armani Code after shave balm")) {
		System.out.println("The product details added are correct");
	}
}
...
public void verify_the_payment_details_for_the_products_added() {
	...
	String price=crt.totalAmountToPay();
	
	if(price.contains("$44.00")) {
